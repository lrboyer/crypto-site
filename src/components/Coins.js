...
const Coins = (props) => {
  ...
  return (
    <div className="font-ubuntu text-white max-w-6xl m-auto mt-20 bg-navyblue w-full rounded-xl"> {/*Container*/}
      ...
      {props.coins.map(coins => {
        return ( 
          ...
          <Link to={`/coin/${coins.id}`} element={<ProtectedRoute><Coin /> </ProtectedRoute>} key={coins.id}>
